                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="space-y-8 lg:space-y-12">
                        {services.map((service, idx) => (
                            <Reveal key={idx}>
                                <div className="group relative bg-white/70 backdrop-blur-xl rounded-[28px] p-8 md:p-12 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgba(38,125,145,0.1)] transition-all duration-500 border border-white hover:border-[#3AABB8]/30 flex flex-col md:flex-row gap-8 lg:gap-12 items-center overflow-hidden">
