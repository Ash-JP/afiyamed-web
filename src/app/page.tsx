import { CheckCircle, ShieldCheck, Truck, BadgeDollarSign, Headphones } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight">
              <span className="text-cyan-600">Al Afiya</span>{" "}
              <span className="text-cyan-600">Medical Supplies</span>
            </h1>
            <p className="text-xl text-blue-600 font-medium mt-4">
              Reliable Partner in Surgical & Medical Equipment Distribution
            </p>
            <p className="text-lg md:text-xl text-slate-600 mb-8 leading-relaxed">
              Delivering quality medical and surgical supplies with a commitment to reliability, efficiency, and customer satisfaction.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            Al Afiya Medical Supplies is a Dubai-based medical trading company specializing in the distribution of surgical equipment and healthcare supplies. We support hospitals, clinics, and healthcare providers by delivering dependable products that meet professional standards.
          </p>
        </div>
      </section>
