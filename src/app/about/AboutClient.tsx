                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {[
                                ...
                                <Reveal key={index}>
                                    <div className="group bg-white/60 backdrop-blur-xl p-6 rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_30px_rgba(38,125,145,0.1)] transition-all border border-[#D6E9EC] hover:border-[#3AABB8]/40 hover:-translate-y-1">
                    ...
                    <div className="relative mt-12 md:mt-24">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 overflow-x-auto pb-10 px-2 md:px-0">
                            {[
                                ...
                                <Reveal key={index}>
                                    <div className="relative flex-1 min-w-[280px] flex flex-col md:items-center">
                                        {/* The Year Label */}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {[
                            ...
                            <Reveal key={index}>
                                <div className="bg-white rounded-[24px] p-8 shadow-sm border border-[#D6E9EC] flex gap-6 h-full">
